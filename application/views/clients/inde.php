                        ...
                        <div class="border_box">
                            <div class="box_skitter box_skitter_large">
                                <ul>
                                    ...
                                    <!--                                        <a href="#cube">-->
                                    <!--<!--                                            <div class="circles">-->-->
                                    <!--                                                <div class='col-md-2 col-sm-4 col-xs-6 circles'>-->
                                    <!--                                                    <div class='lightbox-item div-img'>-->
                                    <!--                                                        <img src="--><?php //echo base_url('assets/img/clients/air_india.png');?><!--" alt="...">-->
                                    <!--                                                    </div>-->
                                    <!--                                                </div>-->
                                    <!--                                                <div class='col-md-2 col-sm-4 col-xs-6 class="circles"'>-->
                                    <!--                                                    <div class='lightbox-item div-img'>-->
                                    ...
                                    <!--                                    <li>-->
                                    <!--                                        <a href="#cubeRandom">-->
                                    <!--                                            <img src="--><?php //echo base_url('assets/images/example/002.jpg');?><!--" class="circlesInside" />-->
                                    <!--                                        </a>-->
                                    <!--                                    </li>-->
                                    <!--                                    <li>-->
                                    <!--                                        <a href="#block">-->
                                    <!--                                            <img src="--><?php //echo base_url('assets/images/example/003.jpg');?><!--" class="circlesRotate" />-->
                                    <!--                                        </a>-->
                                    <!--                                    </li>-->
                                    <!--                                    <li>-->
                                    <!--                                        <a href="#cubeStop">-->
                                    <!--                                            <img src="--><?php //echo base_url('assets/images/example/004.jpg');?><!--" class="cubeShow" />-->
                                    <!--                                        </a>-->
                                    <!--                                    </li>-->
                                </ul>
                            </div>
