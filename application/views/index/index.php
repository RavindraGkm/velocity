    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand logo-v1" href="<?php echo base_url('');?>">
                <img src="<?php echo base_url('assets/img/logo_1.png');?>" class="img img-responsive" id="logoimg" alt="">
            </a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row service-box">
            <div class="col-md-4 col-sm-4">
                ...
                <p>We realize the significance of timing and dependency on good resources and thus always ensure to fulfill your requirements in time. </p>
            </div>
            <div class="col-md-4 col-sm-4">
                <div class="service-box-heading">
                ...
                <p>At velocity we strive to meet and exceed your expectations, customer satisfaction is our key driver.</p>
            </div>
            <div class="col-md-4 col-sm-4">
                <div class="service-box-heading">
                ...
                <p> Our focus is to provide value add through our unique solutions to enhance your business growth.</p>
            </div>
        </div>
        <div class="row quote-v1">
            <div class="col-md-9 quote-v1-inner">
                <span>Velocity Placements - Download our corporate presentation. </span>
            </div>
            <div class="col-md-3 quote-v1-inner text-right">
                <a class="btn-transparent" href="<?php echo base_url('assets/downloads/Velocity-Services-Profile.pdf');?>" target="_blank"><i class="fa fa-rocket margin-right-10"></i>Download Now</a>
            </div>
        </div>
